...
/**
 * 1. делаем поля private для безопасности
 * 2. создаем getter и setter если поля private
 * 3. создаем полный конструктор и пустой конструктор
 * 4. переопределяем  toString()
 */
